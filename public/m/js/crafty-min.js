...
(function(k, w, h) {
	var r = function(z) {
		return new r.fn.init(z)
	}, y, e, o, n, c, p, s, t, i, a, g, f, b, q, d, u, x = function() {
		y = 1;
		e = 50;
		o = 1;
		n = {};
	...
	r.fn = r.prototype = {
		init : function(D) {
			if (typeof D === "string") {
				var B = 0, H, I, G = false, F = false, J, z, A, E, C;
				if (D === "*") {
					for (H in c) {
						this[+H] = c[H];
						B++
		...
		addComponent : function(F) {
			...
			this.trigger("NewComponent", B);
			return this
		},
		toggleComponent : function(z) {
			var B = 0, A, C;
			if (arguments.length > 1) {
				A = arguments.length;
				for (; B < A; B++) {
					if (this.has(arguments[B])) {
						this.removeComponent(arguments[B])
					} else {
						this.addComponent(arguments[B])
					}
				}
			} else {
				if (z.indexOf(",") !== -1) {
		...
		requires : function(C) {
			var D = C.split(d), B = 0, z = D.length, A;
			for (; B < z; ++B) {
				A = D[B];
				if (!this.has(A)) {
					this.addComponent(A)
		...
		removeComponent : function(C, z) {
			...
			delete this.__c[C];
			this.trigger("RemoveComponent", C);
			return this
		},
		has : function(z) {
			return !!this.__c[z]
		...
		trigger : function(C, D) {
			if (this.length === 1) {
				if (p[C] && p[C][this[0]]) {
					var B = p[C][this[0]], A = 0, z = B.length;
					for (; A < z; A++) {
						B[A].call(this, D)
					}
				}
			...
			this.each(function() {
				if (p[C] && p[C][this[0]]) {
					var G = p[C][this[0]], F = 0, E = G.length;
					for (; F < E; F++) {
						G[F].call(this, D)
					}
				}
		...
		clone : function() {
			var C = this.__c, z, B, A = r.e();
			for (z in C) {
				A.addComponent(z)
			}
			for (B in this) {
				if (B != "0" && B != "_global" && B != "_changed"
						&& typeof this[B] != "function"
	...
	r.extend = r.fn.extend = function(B) {
		var A = this, z;
		if (!B) {
			return A
		}
	...
	r.extend({
		...
		stop : function(z) {
			this.timer.stop();
			if (z) {
				if (r.stage && r.stage.elem.parentNode) {
					var A = document.createElement("div");
					A.id = "cr-stage";
					r.stage.elem.parentNode.replaceChild(A, r.stage.elem)
				}
				x();
				w(r, k, k.document)
			}
		...
		pause : function(z) {
			if (arguments.length == 1 ? z : !this._paused) {
				this.trigger("Pause");
				this._paused = true;
				setTimeout(function() {
					r.timer.stop()
		...
		timer : {
			...
			stop : function() {
				r.trigger("CraftyStopTimer");
				if (typeof t === "number") {
					clearInterval(t)
				}
				var z = k.cancelRequestAnimationFrame
						|| k.webkitCancelRequestAnimationFrame
						|| k.mozCancelRequestAnimationFrame
						|| k.oCancelRequestAnimationFrame
						|| k.msCancelRequestAnimationFrame || null;
				if (z) {
					z(i)
				}
				t = null
			...
			step : function() {
				...
				if (this.currentTime - b > 60 * f) {
					b = this.currentTime - f
				}
				while (this.currentTime > b) {
		...
		addEntityFactory : function(z, A) {
			this.entityFactories[z] = A
		},
		newFactoryEntity : function(z) {
			return this.entityTemplates[z]()
		},
		e : function() {
			var A = m(), z;
			c[A] = null;
			...
			if (arguments.length > 0) {
				z.addComponent.apply(z, arguments)
			}
			z.setName("Entity #" + A);
			z.addComponent("obj");
			r.trigger("NewEntity", {
	...
	r.bind("Load", function() {
		if (!r.support.setter && r.support.defineProperty) {
			...
			r.bind("EnterFrame", function() {
				var A = 0, z = a.length, B;
				for (; A < z; ++A) {
					B = a[A];
					if (B.obj[B.prop] !== B.obj["_" + B.prop]) {
						B.fn.call(B.obj, B.obj[B.prop])
					}
				}
			})
		}
		...
		(
				...
				function(Crafty, window, document) {
					(function(parent) {
						...
						HashMap.prototype = {
							insert : function(obj) {
								var keys = HashMap.key(obj), entry = new Entry(
										keys, obj, this), i = 0, j, hash;
						...
						HashMap.key = function(obj) {
							...
							var x1 = Math.floor(obj._x / cellsize), y1 = Math
									.floor(obj._y / cellsize), x2 = Math
									.floor((obj._w + obj._x) / cellsize), y2 = Math
									.floor((obj._h + obj._y) / cellsize);
							return {
								x1 : x1,
								y1 : y1,
								x2 : x2,
						...
						HashMap.hash = function(keys) {
							return keys.x1 + SPACE + keys.y1 + SPACE + keys.x2
									+ SPACE + keys.y2
						};
						...
						Entry.prototype = {
							update : function(rect) {
								if (HashMap.hash(HashMap.key(rect)) != HashMap
										.hash(this.keys)) {
							...
							.c(
									"2D",
									{
										...
										_defineGetterSetter_setter : function() {
											...
											this.__defineSetter__("w",
													function(v) {
														this._attr("_w", v)
													});
											this.__defineSetter__("h",
													function(v) {
														this._attr("_h", v)
													});
											this.__defineSetter__("z",
													function(v) {
														this._attr("_z", v)
													});
											this.__defineSetter__("rotation",
													function(v) {
														this._attr("_rotation",
																v)
													});
											this.__defineSetter__("alpha",
													function(v) {
														this._attr("_alpha", v)
													});
											this.__defineSetter__("visible",
													function(v) {
														this._attr("_visible",
																v)
													});
											...
											this.__defineGetter__("z",
													function() {
														return this._z
													});
											this.__defineGetter__("rotation",
													function() {
														return this._rotation
													});
											this.__defineGetter__("alpha",
													function() {
														return this._alpha
													});
											this.__defineGetter__("visible",
													function() {
										...
										init : function() {
											...
											if (Crafty.support.setter) {
												this
														._defineGetterSetter_setter()
											} else {
												if (Crafty.support.defineProperty) {
													this
															._defineGetterSetter_defineProperty()
												} else {
													this
															._defineGetterSetter_fallback()
												}
											}
											this._entry = Crafty.map
													.insert(this);
										...
										_rotate : function(v) {
											...
											var x0 = o.x + (this._x - o.x) * ct
													+ (this._y - o.y) * st, y0 = o.y
													- (this._x - o.x)
													* st
													+ (this._y - o.y) * ct, x1 = o.x
													+ (this._x + this._w - o.x)
													* ct + (this._y - o.y) * st, y1 = o.y
													- (this._x + this._w - o.x)
													* st + (this._y - o.y) * ct, x2 = o.x
													+ (this._x + this._w - o.x)
													* ct
													+ (this._y + this._h - o.y)
													* st, y2 = o.y
													...
													* st, y3 = o.y
													...
													+ (this._y + this._h - o.y)
													* ct, minx = Math
													.floor(Math.min(x0, x1, x2,
															x3)), miny = Math
													.floor(Math.min(y0, y1, y2,
															y3)), maxx = Math
													.ceil(Math.max(x0, x1, x2,
															x3)), maxy = Math
													.ceil(Math.max(y0, y1, y2,
															y3));
											this._mbr = {
												_x : minx,
												_y : miny,
											...
											var difference = this._rotation - v, drad = difference
													* DEG_TO_RAD;
											this.trigger("Rotate", {
												cos : Math.cos(drad),
												sin : Math.sin(drad),
										...
										_cascade : function(e) {
											...
											if (e.cos) {
												...
												var rect = this._mbr || this, dx = rect._x
														- e._x, dy = rect._y
														- e._y, dw = rect._w
														- e._w, dh = rect._h
														- e._h;
					...
					Crafty.polygon.prototype = {
						...
						rotate : function(e) {
							...
							for (; i < l; i++) {
								current = this.points[i];
								x = e.o.x + (current[0] - e.o.x) * e.cos
										+ (current[1] - e.o.y) * e.sin;
								y = e.o.y - (current[0] - e.o.x) * e.sin
										+ (current[1] - e.o.y) * e.cos;
								current[0] = x;
								current[1] = y
							}
						}
					...
					Crafty.circle = function(x, y, radius) {
						...
						for (var i = 0; i < 8; i++) {
							theta = i * Math.PI / 4;
							this.points[i] = [
									this.x + (Math.sin(theta) * radius),
									this.y + (Math.cos(theta) * radius) ]
						}
					};
					Crafty.circle.prototype = {
						containsPoint : function(x, y) {
							var radius = this.radius, sqrt = Math.sqrt, deltaX = this.x
									- x, deltaY = this.y - y;
					...
					Crafty.matrix.prototype = {
						...
						e : function(row, col) {
							if (row < 1 || row > this.mtx.length || col < 1
					...
					Crafty
							.c(
									"Collision",
									{
										...
										hit : function(comp) {
											var area = this._mbr || this, results = Crafty.map
													.search(area, false), i = 0, l = results.length, dupes = {}, id, obj, oarea, key, hasMap = ("map" in this && "containsPoint" in this.map), finalresult = [];
											if (!l) {
												return false
											}
											for (; i < l; ++i) {
										...
										_SAT : function(poly1, poly2) {
											...
											for (; i < l; i++) {
												nextPoint = points1[(i == l - 1 ? 0
														: i + 1)];
												currentPoint = points1[i];
												normal.x = -(nextPoint[1] - currentPoint[1]);
												normal.y = (nextPoint[0] - currentPoint[0]);
												length = Math.sqrt(normal.x
														* normal.x + normal.y
														* normal.y);
												normal.x /= length;
												normal.y /= length;
									...
									"DOM",
									{
										...
										init : function() {
											...
											this.bind("NewComponent",
													...
													"RemoveComponent",
													updateClass);
											if (Crafty.support.prefix === "ms"
													&& Crafty.support.version < 9) {
												this._filters = {};
												this
														.bind(
																"Rotate",
																function(e) {
																	var m = e.matrix, elem = this._element.style, M11 = m.M11
																			.toFixed(8), M12 = m.M12
																			.toFixed(8), M21 = m.M21
																			.toFixed(8), M22 = m.M22
																			.toFixed(8);
																	this._filters.rotation = "progid:DXImageTransform.Microsoft.Matrix(M11="
																			+ M11
																			+ ", M12="
																			+ M12
																			+ ", M21="
										...
										draw : function() {
											var style = this._element.style, coord = this.__coord
													|| [ 0, 0, 0, 0 ], co = {
												x : coord[0],
												y : coord[1]
											...
											if (prefix === "ms"
												...
												if (Crafty.support.version === 8) {
													this._filters.alpha = "progid:DXImageTransform.Microsoft.Alpha(Opacity="
															+ (this._alpha * 100)
															+ ")"
												} else {
													this._filters.alpha = "alpha(opacity="
															+ (this._alpha * 100)
															+ ")"
												}
											}
											if (this._mbr) {
												var origin = this._origin.x
														+ "px "
														+ this._origin.y + "px";
											...
											if (this._cssStyles.transform != trans
													.join(" ")) {
												this._cssStyles.transform = trans
														.join(" ");
					...
					Crafty
							.extend({
								DOM : {
									...
									inner : function(obj) {
										var rect = obj.getBoundingClientRect(), x = rect.left
												+ (window.pageXOffset ? window.pageXOffset
														: document.body.scrollLeft), y = rect.top
												+ (window.pageYOffset ? window.pageYOffset
														: document.body.scrollTop), borderX = parseInt(
												this.getStyle(obj,
														"border-left-width") || 0,
												10)
												|| parseInt(
														this
																.getStyle(obj,
																		"borderLeftWidth") || 0,
														10) || 0, borderY = parseInt(
												this.getStyle(obj,
														"border-top-width") || 0,
												10)
												|| parseInt(this.getStyle(obj,
														"borderTopWidth") || 0,
														10) || 0;
										x += borderX;
										y += borderY;
									...
									translate : function(x, y) {
										return {
											x : (x
													...
													+ document.documentElement.scrollLeft - Crafty.viewport._x)
													/ Crafty.viewport._zoom,
											y : (y
													- Crafty.stage.y
													+ document.body.scrollTop
													+ document.documentElement.scrollTop - Crafty.viewport._y)
													/ Crafty.viewport._zoom
										}
									}
								}
					...
					Crafty.storage = (function() {
						...
						function process(obj) {
							if (obj.c) {
								var d = Crafty.e(obj.c).attr(obj.attr).trigger(
										"LoadData", obj, process);
								return d
							} else {
								if (typeof obj == "object") {
									for ( var prop in obj) {
						...
						function saveExternal(key, data, ts) {
							...
							xhr.open("POST", url);
							xhr.send("mode=save&key=" + key + "&data="
									+ encodeURIComponent(data) + "&ts=" + ts
									+ "&game=" + gameName)
						}
						function loadExternal(key) {
							...
							xhr.send("mode=load&key=" + key + "&game="
									+ gameName)
						}
						function ts() {
							var d = new Date();
						...
						if (typeof indexedDB != "object") {
							...
							if (typeof IDBTransaction == "object") {
								transactionType.READ = IDBTransaction.READ
						...
						if (typeof indexedDB == "object") {
							return {
									...
									function getTimestamps() {
										try {
											var trans = db.transaction(
													[ "save" ],
													transactionType.READ), store = trans
													.objectStore("save"), request = store
													.getAll();
											request.onsuccess = function(e) {
								...
								save : function(key, type, data) {
									...
									try {
										var trans = db.transaction([ type ],
												transactionType.READ_WRITE), store = trans
												.objectStore(type), request = store
												.put({
													data : str,
													timestamp : t,
													key : key
								...
								getAllKeys : function(type, callback) {
									if (db == null) {
										setTimeout(function() {
											Crafty.storage.getAllkeys(type,
													callback)
										}, 1)
									}
									try {
							...
							if (typeof openDatabase == "function") {
								return {
									open : function(gameName_n) {
										...
										if (arguments.length == 1) {
											db = {
												save : openDatabase(gameName_n
														+ "_save", "1.0",
														"Saves games for "
																+ gameName_n,
														5 * 1024 * 1024),
												cache : openDatabase(gameName_n
														+ "_cache", "1.0",
														"Cache for "
																+ gameName_n,
														5 * 1024 * 1024)
									...
									save : function(key, type, data) {
										...
										db[type]
												.transaction(function(tx) {
													tx
															.executeSql("CREATE TABLE IF NOT EXISTS data (key unique, text, timestamp)");
													tx
															.executeSql(
								...
								if (typeof window.localStorage == "object") {
									return {
										...
										load : function(key, type, callback) {
											var k = gameName + "." + type + "."
													+ key, str = window.localStorage[k];
											callback(unserialize(str))
										},
										getAllKeys : function(type, callback) {
											var res = {}, output = [], header = gameName
													+ "." + type;
											for ( var i in window.localStorage) {
												if (i.indexOf(header) != -1) {
													var key = i.replace(header,
															"").replace(".ts",
															"");
													res[key] = true
												}
										...
										check : function(key, timestamp) {
											var ts = window.localStorage[gameName
													+ ".save." + key + ".ts"];
									...
									return {
										...
										load : function(key, type, callback) {
											...
											var reg = new RegExp(gameName + "_"
													+ key + "=[^;]*"), result = reg
													.exec(document.cookie), data = unserialize(result[0]
													.replace(gameName + "_"
															+ key + "=", ""));
											callback(data)
										},
										getAllKeys : function(type, callback) {
											...
											var reg = new RegExp(gameName
													+ "_[^_=]", "g"), matches = reg
													.exec(document.cookie), i = 0, l = matches.length, res = {}, output = [];
											for (; i < l; i++) {
										...
										check : function(key, timestamp) {
											var header = gameName + "_" + key
													+ "_ts", reg = new RegExp(
													header + "=[^;]"), result = reg
													.exec(document.cookie), ts = result[0]
													.replace(header + "=", "");
											return (parseInt(timestamp) > parseInt(ts))
										},
										external : external
					...
					(function testSupport() {
						var support = Crafty.support = {}, ua = navigator.userAgent
								.toLowerCase(), match = /(webkit)[ \/]([\w.]+)/
								.exec(ua)
								|| /(o)pera(?:.*version)?[ \/]([\w.]+)/
										.exec(ua)
								|| /(ms)ie ([\w.]+)/.exec(ua)
								|| /(moz)illa(?:.*? rv:([\w.]+))?/.exec(ua)
								|| [], mobile = /iPad|iPod|iPhone|Android|webOS|IEMobile/i
								.exec(ua);
						if (mobile) {
						...
						support.canvas = ("getContext" in document
								.createElement("canvas"));
						if (support.canvas) {
							var gl;
							try {
						...
						support.css3dtransform = (typeof document
								.createElement("div").style.Perspective !== "undefined")
								|| (typeof document.createElement("div").style[support.prefix
										+ "Perspective"] !== "undefined");
						support.deviceorientation = (typeof window.DeviceOrientationEvent !== "undefined")
					...
					Crafty
							.extend({
								...
								sprite : function(tile, tileh, url, map,
										paddingX, paddingY) {
								...
								removeEvent : function(ctx, obj, type, callback) {
									...
									var id = ctx[0] || "", afn = this._events[id
											+ obj + type + callback];
									if (afn) {
										if (obj.detachEvent) {
											obj.detachEvent("on" + type, afn)
										} else {
											obj.removeEventListener(type, afn,
													false)
										}
										delete this._events[id + obj + type
												+ callback]
									}
								},
								...
								viewport : {
										...
										function change() {
											Crafty.viewport
													.scroll(
															...
															-(this.x
																	+ (this.w / 2)
																	- (Crafty.viewport.width / 2) - offx));
											Crafty.viewport
													.scroll(
															"_y",
															-(this.y
																	+ (this.h / 2)
																	- (Crafty.viewport.height / 2) - offy));
											Crafty.viewport._clamp()
										}
										return function(target, offsetx,
												offsety) {
											if (oldTarget) {
												oldTarget.unbind("Change",
														change)
											}
											...
											oldTarget = target;
											offx = (typeof offsetx != "undefined") ? offsetx
													: 0;
											offy = (typeof offsety != "undefined") ? offsety
													: 0;
									...
									centerOn : function(targ, time) {
										var x = targ.x, y = targ.y, mid_x = targ.w / 2, mid_y = targ.h / 2, cent_x = Crafty.viewport.width / 2, cent_y = Crafty.viewport.height / 2, new_x = x
												+ mid_x - cent_x, new_y = y
												+ mid_y - cent_y;
										Crafty.viewport.pan("reset");
									...
									_zoom : 1,
									zoom : (function() {
										var zoom = 1, zoom_tick = 0, dur = 0, prop = Crafty.support.prefix
												+ "Transform", bound = false, act = {}, prct = {};
										function enterFrame() {
											if (dur > 0) {
												...
												Crafty.stage.inner.style[prop] = "scale("
														+ zoom
														+ ","
														+ zoom
														+ ")";
												...
												Crafty.viewport.x -= diff.width
														* prct.width;
												Crafty.viewport.y -= diff.height
														* prct.height;
												dur--
											}
										}
										return function(amt, cent_x, cent_y,
												time) {
											var bounds = this.bounds
													|| Crafty.map.boundaries(), final_zoom = amt ? zoom
													* amt
													: 1;
											if (!amt) {
												zoom = 1;
											...
											act.width = bounds.max.x
													- bounds.min.x;
											act.height = bounds.max.y
													- bounds.min.y;
									...
									scale : (function() {
										var prop = Crafty.support.prefix
												+ "Transform", act = {};
										return function(amt) {
											var bounds = this.bounds
													|| Crafty.map.boundaries(), final_zoom = amt ? this._zoom
													* amt
													: 1, czoom = final_zoom
													/ this._zoom;
											...
											Crafty.viewport.pan("reset");
											Crafty.stage.inner.style.transform = Crafty.stage.inner.style[prop] = "scale("
													+ this._zoom
													+ ","
													+ this._zoom + ")";
											if (Crafty.canvas._canvas) {
												Crafty.canvas.context.scale(
														czoom, czoom);
												Crafty.DrawManager.drawAll()
											}
										}
										...
										if (bound.max.y - bound.min.y > Crafty.viewport.height) {
											...
											Crafty.viewport.y = -1
													* (bound.min.y
															...
															/ 2 - Crafty.viewport.height / 2)
										}
									},
									init : function(w, h) {
										Crafty.DOM.window.init();
										this.width = (!w || Crafty.mobile) ? Crafty.DOM.window.width
												: w;
										this.height = (!h || Crafty.mobile) ? Crafty.DOM.window.height
												: h;
										var crstage = document
												.getElementById("cr-stage");
										Crafty.stage = {
											x : 0,
											y : 0,
											fullscreen : false,
											elem : (crstage ? crstage
													: document
															.createElement("div")),
											inner : document
													.createElement("div")
										...
										Crafty.addEvent(this, window, "resize",
												Crafty.viewport.reload);
										Crafty.addEvent(this, window, "blur",
												function() {
													if (Crafty.settings
															.get("autoPause")) {
														if (!Crafty._paused) {
										...
										Crafty.settings.modify(
												"stageContextMenu", false);
										Crafty.settings.register("autoPause",
												function() {
												});
										Crafty.settings.modify("autoPause",
												false);
										if (!crstage) {
											document.body
													.appendChild(Crafty.stage.elem);
											Crafty.stage.elem.id = "cr-stage"
										}
										var elem = Crafty.stage.elem.style, offset;
										Crafty.stage.elem
												.appendChild(Crafty.stage.inner);
										...
										if (Crafty.mobile) {
											...
											var meta = document
													.createElement("meta"), head = document
									...
									reload : function() {
										...
										if (Crafty.stage.fullscreen) {
											...
											Crafty.stage.elem.style.width = w
													+ "px";
											Crafty.stage.elem.style.height = h
													+ "px";
											if (Crafty.canvas._canvas) {
						...
						init : function() {
							this.bind("EnterFrame", function() {
								if (Crafty.viewport._x !== Crafty.viewport.x) {
									Crafty.viewport.scroll("_x",
											Crafty.viewport.x)
								}
								if (Crafty.viewport._y !== Crafty.viewport.y) {
									Crafty.viewport.scroll("_y",
											Crafty.viewport.y)
								}
							})
						}
					...
					Crafty
							.extend({
								device : {
									...
									_normalizeDeviceOrientation : function(
											eventData) {
										var data;
										...
										Crafty.device
												._deviceOrientationCallback(data)
									},
									_normalizeDeviceMotion : function(eventData) {
										var acceleration = eventData.accelerationIncludingGravity, facingUp = (acceleration.z > 0) ? +1
												: -1;
										var data = {
											...
											facingUp : facingUp,
											tiltLR : Math
													.round(((acceleration.x) / 9.81)
															* -90),
											tiltFB : Math
													.round(((acceleration.y + 9.81) / 9.81)
															* 90 * facingUp)
										};
										Crafty.device
												._deviceMotionCallback(data)
									},
										...
										init : function() {
											...
											var draw = function(e) {
												...
												if (e.type === "canvas") {
													...
													if (e.type === "DOM") {
														this._element.style.background = "url('"
																+ this.__image
																+ "') no-repeat -"
																+ co.x
																+ "px -"
													...
													.bind(
															...
															function(e) {
																if (this._changed === false) {
																	this._changed = Crafty.DrawManager
																			.add(
																					e
																							|| this,
																					this)
										...
										draw : function(ctx, x, y, w, h) {
											...
											var pos = {
												...
												_h : (h || this._h)
													...
													|| Crafty.canvas.context, coord = this.__coord
													|| [ 0, 0, 0, 0 ], co = {
												x : coord[0] + (x || 0),
												y : coord[1] + (y || 0),
												w : w || coord[2],
											...
											if (this._mbr) {
												...
												context
														.rotate((this._rotation % 360)
																* (Math.PI / 180))
											}
											if (this._flipX || this._flipY) {
												context.save();
												context.scale((this._flipX ? -1
														: 1), (this._flipY ? -1
														: 1));
												if (this._flipX) {
					...
					Crafty
							.extend({
								...
								detectBlur : function(e) {
									var selected = ((e.clientX > Crafty.stage.x && e.clientX < Crafty.stage.x
											+ Crafty.viewport.width) && (e.clientY > Crafty.stage.y && e.clientY < Crafty.stage.y
											+ Crafty.viewport.height));
								...
								mouseDispatch : function(e) {
									...
									Crafty.lastEvent = e;
									var maxz = -1, closest, q, i = 0, l, pos = Crafty.DOM
											.translate(e.clientX, e.clientY), x, y, dupes = {}, tar = e.target ? e.target
											: e.srcElement, type = e.type;
									if (e.which == null) {
										e.mouseButton = (e.button < 2) ? Crafty.mouseButtons.LEFT
												: ((e.button == 4) ? Crafty.mouseButtons.MIDDLE
														: Crafty.mouseButtons.RIGHT)
									} else {
										e.mouseButton = (e.which < 2) ? Crafty.mouseButtons.LEFT
												: ((e.which == 2) ? Crafty.mouseButtons.MIDDLE
														: Crafty.mouseButtons.RIGHT)
									}
									e.realX = x = Crafty.mousePos.x = pos.x;
									e.realY = y = Crafty.mousePos.y = pos.y;
									if (tar.nodeName != "CANVAS") {
										while (typeof (tar.id) != "string"
												&& tar.id.indexOf("ent") == -1) {
											tar = tar.parentNode
										}
										ent = Crafty(parseInt(tar.id.replace(
												"ent", "")));
									...
									if (closest) {
										...
										if (type === "mousedown") {
											Crafty.viewport.mouselook("start",
													e)
										} else {
											if (type === "mousemove") {
					...
					Crafty.bind("Load",
							function() {
								...
								Crafty.addEvent(this, "keyup",
										Crafty.keyboardDispatch);
								Crafty.addEvent(this, Crafty.stage.elem,
										"mousedown", Crafty.mouseDispatch);
								Crafty.addEvent(this, Crafty.stage.elem,
										"mouseup", Crafty.mouseDispatch);
								Crafty.addEvent(this, document.body, "mouseup",
										Crafty.detectBlur);
								Crafty.addEvent(this, Crafty.stage.elem,
										"mousemove", Crafty.mouseDispatch);
								Crafty.addEvent(this, Crafty.stage.elem,
										"click", Crafty.mouseDispatch);
								Crafty.addEvent(this, Crafty.stage.elem,
										"dblclick", Crafty.mouseDispatch);
								Crafty.addEvent(this, Crafty.stage.elem,
										"touchstart", Crafty.touchDispatch);
								Crafty.addEvent(this, Crafty.stage.elem,
										"touchmove", Crafty.touchDispatch);
								Crafty.addEvent(this, Crafty.stage.elem,
										"touchend", Crafty.touchDispatch);
								Crafty.addEvent(this, Crafty.stage.elem,
										"touchcancel", Crafty.touchDispatch);
								Crafty.addEvent(this, Crafty.stage.elem,
										"touchleave", Crafty.touchDispatch)
							});
					Crafty.bind("CraftyStop", function() {
						Crafty.removeEvent(this, "keydown",
								Crafty.keyboardDispatch);
						Crafty.removeEvent(this, "keyup",
								Crafty.keyboardDispatch);
						if (Crafty.stage) {
							Crafty.removeEvent(this, Crafty.stage.elem,
									"mousedown", Crafty.mouseDispatch);
							Crafty.removeEvent(this, Crafty.stage.elem,
									"mouseup", Crafty.mouseDispatch);
							Crafty.removeEvent(this, Crafty.stage.elem,
									...
									"Draggable",
									{
										...
										init : function() {
											...
											this._ondrag = function(e) {
												var pos = Crafty.DOM.translate(
														e.clientX, e.clientY);
												if (pos.x == 0 || pos.y == 0) {
													return false
												}
												if (this._dir) {
													var len = (pos.x - this._origMouseDOMPos.x)
															* this._dir.x
															+ (pos.y - this._origMouseDOMPos.y)
															* this._dir.y;
													this.x = this._oldX + len
															* this._dir.x;
													this.y = this._oldY + len
															* this._dir.y
												} else {
													this.x = this._oldX
															+ (pos.x - this._origMouseDOMPos.x);
													this.y = this._oldY
															+ (pos.y - this._origMouseDOMPos.y)
												}
										...
										_startDrag : function(e) {
											this._origMouseDOMPos = Crafty.DOM
													.translate(e.clientX,
															e.clientY);
											this._oldX = this._x;
											this._oldY = this._y;
											this._dragging = true;
											Crafty.addEvent(this,
													Crafty.stage.elem,
					...
					Crafty
							.c(
									"Multiway",
									{
										...
										_keydown : function(e) {
											if (this._keys[e.key]) {
												this._movement.x = Math
														.round((this._movement.x + this._keys[e.key].x) * 1000) / 1000;
												this._movement.y = Math
														.round((this._movement.y + this._keys[e.key].y) * 1000) / 1000;
										...
										speed : function(speed) {
											for ( var k in this._keyDirection) {
												...
												this._keys[keyCode] = {
													x : Math
															.round(Math
																	.cos(this._keyDirection[k]
																			* (Math.PI / 180))
																	* 1000
																	* speed.x) / 1000,
													y : Math
															.round(Math
																	.sin(this._keyDirection[k]
																			* (Math.PI / 180))
																	* 1000
																	* speed.y) / 1000
												}
					...
					Crafty
							.c(
									"SpriteAnimation",
									{
										...
										animate : function(reelId, fromx, y,
												tox) {
											...
											if (arguments.length < 4
												...
												this._frame = {
													...
													numberOfFramesBetweenSlides : Math
															.ceil(duration
																	/ currentReel.length),
										...
										updateSprite : function() {
											...
											if (data.currentSlideNumber === data.currentReel.length) {
												if (this._frame.repeatInfinitly === true
														|| this._frame.repeat > 0) {
					...
					function tweenEnterFrame(e) {
						...
						if (this.has("Mouse")) {
							...
							if (over && over[0] == this[0]
									&& !this.isAt(mouse.x, mouse.y)) {
							...
							this.bind("Draw", function(e) {
								if (e.type === "DOM") {
									...
									if (e.type === "canvas") {
										...
										e.ctx.fillRect(e.pos._x, e.pos._y,
												e.pos._w, e.pos._h)
									}
								}
							})
					...
					Crafty.c("Tint",
							{
								...
								init : function() {
									var draw = function d(e) {
										...
										context.fillStyle = this._color
												|| "rgb(0,0,0)";
										context.fillRect(e.pos._x, e.pos._y,
												e.pos._w, e.pos._h)
									};
									this.bind("Draw", draw).bind(
								...
								tint : function(color, strength) {
									...
									this._color = Crafty.toRGB(color,
											this._strength);
									this.trigger("Change");
									return this
								}
					...
					Crafty.c("Image", {
						...
						init : function() {
							...
							this.bind("Draw", draw).bind("RemoveComponent",
									function(id) {
										if (id === "Image") {
											this.unbind("Draw", draw)
										}
						...
						image : function(url, repeat) {
							...
							if (!this.img) {
								...
								this.img.onload = function() {
									if (self.has("Canvas")) {
										self._pattern = Crafty.canvas.context
												.createPattern(self.img,
														self._repeat)
									}
									self.ready = true;
								...
								this.ready = true;
								if (this.has("Canvas")) {
									this._pattern = Crafty.canvas.context
											.createPattern(this.img,
													this._repeat)
								}
								...
								scene : function(name, intro, outro) {
									if (arguments.length === 1) {
										...
										if (this._current !== null
											...
											this._scenes[this._current].uninitialize
													.call(this)
										}
										this._scenes[name].initialize
												.call(this);
					...
					Crafty.DrawManager = (function() {
						...
						return {
							...
							onScreen : function(rect) {
								return Crafty.viewport._x + rect._x + rect._w > 0
										&& Crafty.viewport._y + rect._y
												+ rect._h > 0
								...
								do {
									...
									while (i < l) {
										...
										if (i < l - 1
											...
											merger = {
												_x : ~~Math.min(current._x,
														next._x),
												_y : ~~Math.min(current._y,
														next._y),
												_w : Math.max(current._x,
														next._x)
														+ Math.max(current._w,
																next._w),
												_h : Math.max(current._y,
														next._y)
														+ Math.max(current._h,
																next._h)
											};
											...
											merger._w = (merger._w == ~~merger._w) ? merger._w
													: merger._w + 1 | 0;
											merger._h = (merger._h == ~~merger._h) ? merger._h
													: merger._h + 1 | 0;
											newset.push(merger);
											i++;
											didMerge = true
									...
									set = newset.length ? Crafty.clone(newset)
											: set;
									if (didMerge) {
										i = 0
									}
							...
							add : function add(old, current) {
								...
								var rect, before = old._mbr || old, after = current._mbr
										|| current;
								if (old === current) {
									...
									rect = {
										...
										_w : Math.max(before._w, after._w)
												+ Math.max(before._x, after._x),
										_h : Math.max(before._h, after._h)
												+ Math.max(before._y, after._y)
									};
								...
								rect._x = ~~rect._x;
								rect._y = ~~rect._y;
								rect._w = (rect._w === ~~rect._w) ? rect._w
										: rect._w + 1 | 0;
								rect._h = (rect._h === ~~rect._h) ? rect._h
										: rect._h + 1 | 0;
							...
							drawAll : function(rect) {
								var rect = rect || Crafty.viewport.rect(), q = Crafty.map
										.search(rect), i = 0, l = q.length, ctx = Crafty.canvas.context, current;
								ctx.clearRect(rect._x, rect._y, rect._w,
										rect._h);
								q.sort(function(a, b) {
							...
							boundingRect : function(set) {
								...
								master = [ master._x, master._y,
										master._x + master._w,
										master._y + master._h ];
								while (i < l) {
									current = set[i];
									tmp = [ current._x, current._y,
							...
							draw : function draw() {
								...
								for (i = 0, l = objs.length; i < l; ++i) {
									...
									rect = obj.rect;
									ent = obj.obj;
									var area = ent._mbr || ent, x = (rect._x
											- area._x <= 0) ? 0
											: ~~(rect._x - area._x), y = (rect._y
											- area._y < 0) ? 0
											: ~~(rect._y - area._y), w = ~~Math
											.min(area._w - x, rect._w
													- (area._x - rect._x),
													rect._w, area._w), h = ~~Math
											.min(area._h - y, rect._h
													- (area._y - rect._y),
													rect._h, area._h);
									if (h === 0 || w === 0) {
										continue
									...
									ctx.lineTo(rect._x + rect._w, rect._h
											+ rect._y);
					...
					Crafty.extend({
						isometric : {
							...
							size : function(width, height) {
								...
								this._tile.height = height > 0 ? height
										: width / 2;
								return this
							},
							...
							centerAt : function(x, y) {
								if (typeof x == "number"
									...
									Crafty.viewport._x = -center.left
											+ Crafty.viewport.width / 2
											- this._tile.width / 2;
									Crafty.viewport._y = -center.top
											+ Crafty.viewport.height / 2
											- this._tile.height / 2;
									return this
								} else {
									return {
										top : -Crafty.viewport._y
												+ Crafty.viewport.height / 2
												- this._tile.height / 2,
										left : -Crafty.viewport._x
												+ Crafty.viewport.width / 2
												- this._tile.width / 2
									}
								}
							...
							area : function() {
								...
								var start = this.px2pos(-center.left
										+ Crafty.viewport.width / 2,
										-center.top + Crafty.viewport.height
												/ 2);
								var end = this.px2pos(-center.left
										- Crafty.viewport.width / 2,
										-center.top - Crafty.viewport.height
												/ 2);
								return {
							...
							.extend({
								diamondIso : {
									...
									init : function(tw, th, mw, mh) {
										...
										this._tile.height = parseInt(th)
												|| parseInt(tw) / 2;
										this._tile.r = this._tile.width
												/ this._tile.height;
										this._map.width = parseInt(mw);
										this._map.height = parseInt(mh)
												|| parseInt(mw);
										this._origin.x = this._map.height
												* this._tile.width / 2;
										return this
									},
					...
					Crafty
							.c(
									...
									{
										init : function() {
											this._Particles = Crafty
													.clone(this._Particles)
										},
										particles : function(options) {
											if (!Crafty.support.canvas
													|| Crafty.deactivateParticles) {
												return this
											}
											...
											relativeY = this.y
													+ Crafty.viewport.y;
											this._Particles.position = this._Particles.vectorHelpers
													.create(relativeX,
															relativeY);
											var oldViewport = {
												x : Crafty.viewport.x,
													...
													.bind(
															...
															function() {
																...
																if (typeof Crafty.DrawManager.boundingRect == "function") {
																	bounding = Crafty.DrawManager
																			.boundingRect(this._Particles.register);
																	if (bounding) {
																		ctx
																				.clearRect(
																						bounding._x,
										...
										_Particles : {
											presets : {
												...
												startColourRandom : [ 48, 50,
														45, 0 ],
												endColour : [ 245, 35, 0, 0 ],
												endColourRandom : [ 60, 60, 60,
														0 ],
												sharpness : 20,
												sharpnessRandom : 10,
												spread : 10,
											...
											init : function(options) {
												this.position = this.vectorHelpers
														.create(0, 0);
												...
												this.emissionRate = this.maxParticles
														/ this.lifeSpan;
												this.positionRandom = this.vectorHelpers
														.create(this.spread,
																this.spread)
											},
											...
											initParticle : function(particle) {
												particle.position.x = this.position.x
														+ this.positionRandom.x
														* this.RANDM1TO1();
												particle.position.y = this.position.y
														+ this.positionRandom.y
														* this.RANDM1TO1();
												var newAngle = (this.angle + this.angleRandom
														* this.RANDM1TO1())
														* (Math.PI / 180);
												var vector = this.vectorHelpers
														.create(
																Math
																		.sin(newAngle),
																-Math
																		.cos(newAngle));
												var vectorSpeed = this.speed
														+ this.speedRandom
														* this.RANDM1TO1();
												particle.direction = this.vectorHelpers
														.multiply(vector,
																vectorSpeed);
												particle.size = this.size
														+ this.sizeRandom
														* this.RANDM1TO1();
												particle.size = particle.size < 0 ? 0
														: ~~particle.size;
												particle.timeToLive = this.lifeSpan
														+ this.lifeSpanRandom
														* this.RANDM1TO1();
												particle.sharpness = this.sharpness
														+ this.sharpnessRandom
														* this.RANDM1TO1();
												particle.sharpness = particle.sharpness > 100 ? 100
														: particle.sharpness < 0 ? 0
																: particle.sharpness;
												particle.sizeSmall = ~~((particle.size / 200) * particle.sharpness);
												var start = [
														this.startColour[0]
																+ this.startColourRandom[0]
																* this
																		.RANDM1TO1(),
														this.startColour[1]
																+ this.startColourRandom[1]
																* this
																		.RANDM1TO1(),
														this.startColour[2]
																+ this.startColourRandom[2]
																* this
																		.RANDM1TO1(),
														this.startColour[3]
																+ this.startColourRandom[3]
																* this
																		.RANDM1TO1() ];
												var end = [
														this.endColour[0]
																+ this.endColourRandom[0]
																* this
																		.RANDM1TO1(),
														this.endColour[1]
																+ this.endColourRandom[1]
																* this
																		.RANDM1TO1(),
														this.endColour[2]
																+ this.endColourRandom[2]
																* this
																		.RANDM1TO1(),
														this.endColour[3]
																+ this.endColourRandom[3]
																* this
																		.RANDM1TO1() ];
												particle.colour = start;
												particle.deltaColour[0] = (end[0] - start[0])
														/ particle.timeToLive;
												particle.deltaColour[1] = (end[1] - start[1])
														/ particle.timeToLive;
												particle.deltaColour[2] = (end[2] - start[2])
														/ particle.timeToLive;
												particle.deltaColour[3] = (end[3] - start[3])
														/ particle.timeToLive
											},
											update : function() {
												if (this.active
												...
												while (this.particleIndex < this.particleCount) {
													...
													if (currentParticle.timeToLive > 0) {
														currentParticle.direction = this.vectorHelpers
																.add(
																		currentParticle.direction,
																		this.gravity);
														currentParticle.position = this.vectorHelpers
																.add(
														...
														currentParticle.position = this.vectorHelpers
																.add(
																		...
																		this.viewportDelta);
														if (this.jitter) {
															currentParticle.position.x += this.jitter
																	* this
																			.RANDM1TO1();
															currentParticle.position.y += this.jitter
																	* this
																			.RANDM1TO1()
														}
																...
																.push((a > 1 ? 1
																		: a < 0 ? 0
																				: a
																						.toFixed(2))
																		+ ")");
														currentParticle.drawColour = draw
																.join(",");
														if (!this.fastMode) {
															draw[3] = "0)";
															currentParticle.drawColourEnd = draw
																	.join(",")
														}
														this.particleIndex++
													} else {
												...
												for (var i = 0, j = this.particleCount; i < j; i++) {
													...
													if (particle.position.x
															...
															|| particle.position.y
																	+ size < 0
															|| particle.position.x
																	- size > Crafty.viewport.width
															|| particle.position.y
																	- size > Crafty.viewport.height) {
														continue
													}
											...
											particle : function(vectorHelpers) {
												this.position = vectorHelpers
														.create(0, 0);
												this.direction = vectorHelpers
														.create(0, 0);
												this.size = 0;
												this.sizeSmall = 0;
												this.timeToLive = 0;
							...
							.extend({
								audio : {
									...
									audioElement : function() {
										return typeof Audio !== "undefined" ? new Audio(
												"")
												: document
														.createElement("audio")
									},
									add : function(id, url) {
										Crafty.support.audio = !!this
							...
							.c(
									"Text",
									{
										...
										textColor : function(color, strength) {
											this._strength = strength;
											this._textColor = Crafty.toRGB(
													color, this._strength);
											this.trigger("Change");
											return this
										},
					...
					Crafty
							.extend({
								...
								load : function(data, oncomplete, onprogress,
										onerror) {
								...
								modules : function(modulesRepository,
										moduleMap, oncomplete) {
									if (arguments.length === 2
											&& typeof modulesRepository === "object") {
										oncomplete = moduleMap;
										moduleMap = modulesRepository;
										modulesRepository = "http://cdn.craftycomponents.com";
									}
									var $script = (function() {
										var win = this, doc = document, head = doc
												.getElementsByTagName("head")[0], validBase = /^https?:\/\//, old = win.$script, list = {}, ids = {}, delay = {}, scriptpath, scripts = {}, s = "string", f = false, push = "push", domContentLoaded = "DOMContentLoaded", readyState = "readyState", addEventListener = "addEventListener", onreadystatechange = "onreadystatechange";
										...
										function $script(paths, idOrDone,
												optDone) {
											paths = paths[push] ? paths
													: [ paths ];
											var idOrDoneIsDone = idOrDone
													&& idOrDone.call, done = idOrDoneIsDone ? idOrDone
													: optDone, id = idOrDoneIsDone ? paths
													.join("")
													: idOrDone, queue = paths.length;
										...
										function create(path, fn) {
											var el = doc
													.createElement("script"), loaded = f;
											el.onload = el.onerror = el[onreadystatechange] = function() {
												if ((el[readyState] && !(/^c|loade/
														.test(el[readyState])))
														|| loaded) {
													return
												}
										...
										$script.get = create;
										$script.order = function(scripts, id,
												done) {
											(function callback(s) {
												s = scripts.shift();
												if (!scripts.length) {
										...
										$script.ready = function(deps, ready,
												req) {
									...
									for ( var i in moduleMap) {
										if (validBase.test(i)) {
											...
											modules.push(modulesRepository
													+ "/"
													+ i.toLowerCase()
													+ "-"
													+ moduleMap[i]
					...
					Crafty.math = {
						...
						distance : function(x1, y1, x2, y2) {
							var squaredDistance = Crafty.math.squaredDistance(
									x1, y1, x2, y2);
					...
					Crafty.math.Vector2D = (function() {
						...
						Vector2D.prototype.angleBetween = function(vecRH) {
							return Math.atan2(this.x * vecRH.y - this.y
									* vecRH.x, this.x * vecRH.x + this.y
									* vecRH.y)
						};
						Vector2D.prototype.angleTo = function(vecRH) {
							return Math.atan2(vecRH.y - this.y, vecRH.x
									- this.x)
						};
						...
						Vector2D.prototype.distance = function(vecRH) {
							return Math.sqrt((vecRH.x - this.x)
									* (vecRH.x - this.x) + (vecRH.y - this.y)
									* (vecRH.y - this.y))
						};
						Vector2D.prototype.distanceSq = function(vecRH) {
							return (vecRH.x - this.x) * (vecRH.x - this.x)
						...
						Vector2D.prototype.getNormal = function(vecRH) {
							...
							return new Vector2D(vecRH.y - this.y, this.x
									- vecRH.x).normalize()
						};
						...
						Vector2D.prototype.normalize = function() {
							var lng = Math.sqrt(this.x * this.x + this.y
									* this.y);
							if (lng === 0) {
								this.x = 1;
								this.y = 0
					...
					Crafty.math.Matrix2D = (function() {
						...
						Matrix2D.prototype.combine = function(mtrxRH) {
							...
							tmp = this.e;
							this.e = tmp * mtrxRH.a + this.f * mtrxRH.c
									+ mtrxRH.e;
							this.f = tmp * mtrxRH.b + this.f * mtrxRH.d
									+ mtrxRH.f;
							return this
						};
						Matrix2D.prototype.equals = function(mtrxRH) {
							return mtrxRH instanceof Matrix2D
									&& this.a == mtrxRH.a && this.b == mtrxRH.b
									&& this.c == mtrxRH.c && this.d == mtrxRH.d
									&& this.e == mtrxRH.e && this.f == mtrxRH.f
						};
						...
						Matrix2D.prototype.setValues = function(a, b, c, d, e,
								f) {
							if (a instanceof Matrix2D) {
								this.a = a.a;
								this.b = a.b;
